...
mixin AuthApiServices {
  ...
  /// * resend forgot code matro
  static Future<CommonSuccessModel?> forgotPasswordResendApi(token) async {
    Map<String, dynamic>? mapResponse;
    try {
      ...
      log.e('🐞🐞🐞 err from forgot resend api service ==> $e 🐞🐞🐞');
      CustomSnackBar.error('Something went Wrong! in forgot resend');
      return null;
    }
    return null;
  }
