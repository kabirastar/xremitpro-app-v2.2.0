...
ManualPaymentModel manualPaymentModelFromJson(String str) =>
    ManualPaymentModel.fromJson(json.decode(str));

String manualPaymentModelToJson(ManualPaymentModel data) =>
