...
SslcommerzModel sslcommerzModelFromJson(String str) =>
    SslcommerzModel.fromJson(json.decode(str));

String sslcommerzModelToJson(SslcommerzModel data) =>
    json.encode(data.toJson());

class SslcommerzModel {
  Message message;
  Data data;
  String type;
  ...
  factory SslcommerzModel.fromJson(Map<String, dynamic> json) =>
      SslcommerzModel(
