...
import '../../backend/model/send_remittance/send_remittance_model.dart';
...
class TransferCalculatorController extends GetxController
  ...
  Future<SendRemittanceModel> sendRemittanceProcess() async {
    ...
    if (amountController.text.isNotEmpty) {
      await transferCalculatorApiProcess(body: inputBody).then((value) {
