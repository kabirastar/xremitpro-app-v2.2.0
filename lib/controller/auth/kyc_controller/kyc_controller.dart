...
import '../../../widgets/kyc/kyc_dynamic_dropdown.dart';
import '../../../widgets/kyc/kyc_dynamic_image_widget.dart';
import '../../../widgets/primary_input_widget.dart';

class KycController extends GetxController with KycApiServices {
  ...
  Future<KycInfoModel> getKycInfoProcess() async {
    ...
    await getKycInfoApi().then((value) {
      _kycInfoModel = value!;
      ...
      if (data[item].type.contains('select')) {
        ...
        inputFields.add(
          Card(
            ...
            elevation: 0,
            child: Padding(
              padding: EdgeInsets.all(Dimensions.paddingSize * 0.542),
              child: Column(
