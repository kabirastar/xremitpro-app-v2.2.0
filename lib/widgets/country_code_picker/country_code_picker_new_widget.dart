...
export 'country_code_new.dart';

class CountryCodePickerNew extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return CountryCodePickerNewState(elements);
  }
}

class CountryCodePickerNewState extends State<CountryCodePickerNew> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  CountryCodePickerNewState(this.elements);
  ...
  @override
  void didUpdateWidget(CountryCodePickerNew oldWidget) {
